...
<script type="text/javascript" language="javascript">
  ...
  function fetch_data()
  {
   var dataTable = $('#user_data').DataTable({
    ...
    "order" : [],
    "ajax" : {
     url:"colmenafunctions/tablefunctions3/fetch.php",
     type:"POST"
    }
   });
  }
  ...
  {
   $.ajax({
    url:"colmenafunctions/tablefunctions3/update.php",
    method:"POST",
  ...
  $(document).on('click', '#insert', function(){
   ...
   {
    $.ajax({
     url:"colmenafunctions/tablefunctions3/insert.php",
     method:"POST",
  ...
  $(document).on('click', '.delete', function(){
   ...
   {
    $.ajax({
     url:"colmenafunctions/tablefunctions3/delete.php",
     method:"POST",
     data:{id:id},
     success:function(data){
      $('#alert_message').html('<div class="alert alert-success">'+data+'</div>');
